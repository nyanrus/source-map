...
import URL from "./url-browser.js"
...
export const toSetString = supportsNullProto ? identity : _toSetString;
...
export const fromSetString = supportsNullProto ? identity : _fromSetString;
